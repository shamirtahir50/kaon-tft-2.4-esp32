...
//          delay(100);
      ...
      if(timesend==true){
       ...
       if(startsamplesend==true){
         ...
         Serial.println(StartSamplingSend);        
      }
      if(stopsamplesend==true){
          stopsamplesend=false;
          StopSamplingSend = "z";
         Serial.println(StopSamplingSend);
      }
       if(startcalibrate==true){   
        ...
        Serial.println(StartCalibrationSend);
...
//        SerialCustom.println(StopCalibrationSend);  
          Serial.println(StopCalibrationSend);        
      }
      }
...
//      stopcalibrate = true;
//      transition = 1;
      Serial.println("Screen_5");
    }
     if(Screenup == true && Screen5_1 == true){
      Screenup = false;
...
//        stopcalibrate = true;
    ...
    if(Screendown == true && Screen5_1 == true){
      Screendown = false;
...
//        stopcalibrate = true;
    ...
    if(Screenenter == true && Screen5_1 == true && confirmyesnotransition == 0){
      Screenenter = false;
      Screen5_1 = false;
      Screen2 = true;
      confirmyesnotransition = 0;
...
//      Serial.println("Screen_12no");
    ...
    if(Screenenter == true && Screen13 == true && webyesnotransition == 1){
      Screenenter = false;
      Screen13 = false;
      Screen8 = true;
      flow = 8.00;
    ...
    if(Screenenter == true && Screen13 == true && webyesnotransition == 0){
      Screenenter = false;
      Screen13 = false;
      Screen8 = true;
      Screen_8T0();
